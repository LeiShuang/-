...
public class ImageLoaderHelper {
    ...
    public static void loadImage(Context context, ImageView imageView, String imagePath, ImageLoaderOptions options) {
        ...
        DrawableTypeRequest<String> request = Glide.with(context).load(imagePath);
        if (options == null) {
...
//                .placeholder(R.mipmap.icon_default)
     ...
     * @param imagePath 图片路径 可能是 网络路径 也可能是本地路径
     */
    public static void loadHeadImage(Context context, ImageView imageView, String imagePath) {
